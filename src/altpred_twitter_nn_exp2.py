...
if __name__ == '__main__':
    ...
    #data = data_processing('altmetrics_j2014_full_gamma.csv', 'tri')

    # prepare the X, Y
    X, Y, max_words, max_len = prepare_word_embeddings(data, 'title', 'target')
