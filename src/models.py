...
from tensorflow.keras.layers import Embedding, Dense, GRU, SimpleRNN

# feedforward network for predicting twitter count
class AltpredTwitterGRU(Model):
    ...
    def __init__(self):
        ...
        # compile the model
        self.model.compile(optimizer=self.rms, loss='mean_squared_error', metrics =['accuracy'])
